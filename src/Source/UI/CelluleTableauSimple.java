 ...
 * @author user
 */
public class CelluleTableauSimple extends javax.swing.JPanel {
     ...
     */
    public CelluleTableauSimple(CouleurBasique couleurBasique, String val, int alignement, ImageIcon iconeEdition) {
        initComponents();
